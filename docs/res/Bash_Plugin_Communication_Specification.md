---
confluence_title: "Bash Plugin Communication Specification"
status: Draft
labels:
  - "LUCI"
  - "specification"
...
<!-- confluence:toc -->
- [Overview](#overview)
- [Protocol Architecture Context](#protocol-architecture-context)
- [When to Use This Specification](#when-to-use-this-specification)
- [Communication Message Structure](#communication-message-structure)
  - [Complete Format Example](#complete-format-example)
- [Field Specifications](#field-specifications)
  - [Message Metadata Section](#message-metadata-section)
  - [Payload Section](#payload-section)
  - [Error Section](#error-section)
  - [Observability Section](#observability-section)
- [Standard Output/Exit Code Conventions](#standard-outputexit-code-conventions)
- [Standard Error Codes and Responses](#standard-error-codes-and-responses)
- [Plugin Invocation and Data Flow](#plugin-invocation-and-data-flow)
- [Error Handling and Recovery](#error-handling-and-recovery)
- [Example Communication Messages](#example-communication-messages)
- [Minimal Required Communication Message](#minimal-required-communication-message)
- [Implementation Guidelines](#implementation-guidelines)
- [Security and Safety Mechanisms](#security-and-safety-mechanisms)
<!-- /confluence:toc -->
<!-- /confluence:expand -->

## Overview

The Bash Plugin Communication Specification (BPCS) defines the standard interface for data exchange between Bash script plugins and the LUCI platform. All plugin communication—input, output, and error handling—is strictly mediated by the LUCI Mediator Module (LMM). No direct communication between plugins and modules, or between plugins, is permitted.
...
**Decision Rule:** Use BPCS for all data exchange between Bash plugins and the LUCI framework (input and output). Use EPS for system-level errors outside plugin execution.

## Communication Message Structure

All communication between Bash plugins and the LUCI framework is performed using JSON-encoded messages via standard input (`stdin`) and output (`stdout`). Plugins may also write diagnostic details to standard error (`stderr`).

### Complete Format Example

#### Input Message (from LUCI to Plugin)
...
#### Output Message (from Plugin to LUCI)
...
This Bash Plugin Communication Specification ensures robust, predictable, and secure integration of Bash plugins within the LUCI platform, supporting modularity, observability, and system stability.
