...
>>>>>>> theirs
    ...
    run_parser.add_argument("--use-ssm", action="store_true", help="Use SSM transport instead of SSH")
    run_parser.add_argument("--dry-run", action="store_true", help="Validate only without execution")
...
def main(argv: list[str] | None = None) -> int:
    ...
    if args.command == "list-actions":
        actions = [action.__dict__ for action in list_actions()]
